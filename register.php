    ...
    <div class="signInContainer">
        <div class="column">
            <div class="header">
                ...
                <h3>Sign Up</h3>
                <span>to continue to Mkplay</span>
            </div>
            <form method="POST">
                ...
                <?php echo $account->getError(Constants::EMAILS_DONT_MATCH); ?>
                ...
                <?php echo $account->getError(Constants::PASSWORDS_DONT_MATCH); ?>
